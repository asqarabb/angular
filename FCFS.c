...
int main()
{
  ...
  //For random test
    ...
    for (Count=0;Count<n;Count++)
    {
      ...
      for(Count=0;Count<n;Count++)
  {
  printf("Arrival Time by random function :%d :%d\n",Count+1,ArrivalTime[Count]);
    printf("Burst Time for Process Number by random  function :%d :%d\n",Count+1,BurstTime[Count]);
